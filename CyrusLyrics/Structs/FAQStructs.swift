...
struct FAQItem: Identifiable {
    ...
    static let items = [
        ...
        FAQItem(name: "What is the best way to learn how to use CyrusLyrics?", items: [
            FAQItem(name: "That would be by tapping the 'View Tutorials' button at the bottom of this page.")
        ]),
        ...
        FAQItem(name: "How do I create my own song lists?", items: [
            FAQItem(name: "From the home page, make sure you're logged in, and then tap 'Create List.' From there, enter your desired list name, and a new Google Sheet will be created for you on your Google account.")
        ]),
        ...
        FAQItem(name: "How do I add songs to my list?", items: [
            FAQItem(name: "After selecting a list, you can tap 'Add Songs' if you have the Google Sheets app installed. This will take you to your active list's Google Sheet. From there, you can follow the column prompts to add the right data.")
        ]),
        FAQItem(name: "How do I edit or delete my lists?", items: [
            FAQItem(name: "From the home page, swipe one of your lists to the left to show the 'Edit' and 'Delete' buttons. If you don't have the Google Sheets app installed, the 'View' button will show instead of 'Edit'.")
        ]),
        ...
        FAQItem(name: "How do I refresh to show my updated songs?", items: [
            FAQItem(name: "After editing your Google Sheet, you can go either to the home page or a specific list's page and pull down to refresh.")
        ]),
        FAQItem(name: "How do I restore a deleted list?", items: [
            FAQItem(name: "Deleting a list through the app will send it to your Google Drive trash, which will allow you 30 days to restore. If you restore the sheet on Google Drive, just pull down on the home page to refresh, and your list will show back up.")
        ]),
        FAQItem(name: "How do I view the preloaded lists in Google Sheets?", items: [
            FAQItem(name: "From the home page, swipe one of the preloaded lists to the left and click the 'View' button.")
        ]),
        FAQItem(name: "Can CyrusLyrics work offline?", items: [
            FAQItem(name: "Yes! Your last selected list will still show without an internet connection, and CyrusLyrics will be able to show the songs for which you have manually updated the 'Lyrics' column in the Google Sheet.")
        ]),
        ...
        FAQItem(name: "How does the shuffle icon work?", items: [
            FAQItem(name: "The shuffle icon will shuffle your list's songs at your current level. I.e. All songs, a single genre, or a single artist.")
        ]),
